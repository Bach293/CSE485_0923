    ...
    <div class="container-fluid" style="padding:70px">
        <div class="row">
            <div class="col" id="admin_content">
                <a href="<?= DOMAIN . 'public/index.php?controller=home&action=add_ClassRoom' ?>"><button
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        foreach ($ClassRooms as $ClassRoom) {
                            ?>
                            <tr>
                                <th scope="row" id="<?= $ClassRoom->getId() ?>">
                                    <?= $ClassRoom->getId() ?>
                                </th>
                                <td>
                                    <?= $ClassRoom->getTenLop() ?>
                                ...
                                <td>
                                    <a
                                        href="<?= DOMAIN . 'public/index.php?controller=home&action=edit_ClassRoom&id=' . $ClassRoom->getId() ?>"><i
                                            class="bi bi-pencil-square">
                                        </i></a>
                                </td>
                                <td>
                                    <a href="<?= DOMAIN . 'public/index.php?controller=home&action=delete_ClassRoom&id=' . $ClassRoom->getId() ?>"
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <li class="page-item"><a class="page-link"
                                    href="<?= DOMAIN . 'public/index.php?controller=home&action=ClassRoom&key=' . $previous ?>">Previous</a>
                            </li>
                            <?php
                            for ($i = 1; $i <= $pages; $i++) {
                                if ($i == 1) {
                                    ...
                                    <li class="page-item"><a class="page-link active" id="<?= $i ?>"
                                            href="<?= DOMAIN . 'public/index.php?controller=home&action=ClassRoom&key=' . $i ?>">
                                            <?= $i ?>
                                        </a></li>
                                    <?php
                                    continue;
                            ...
                            ?>
                            <li class="page-item"><a class="page-link"
                                    href="<?= DOMAIN . 'public/index.php?controller=home&action=ClassRoom&key=' . $next ?>">Next</a>
                            </li>
                        </ul>
                    </nav>
                </div>
