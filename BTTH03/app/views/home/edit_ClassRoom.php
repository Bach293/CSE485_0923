    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col text-center" id="admin_content">
                ...
                <form
                    action="<?= DOMAIN . 'public/index.php?controller=home&action=edit_ClassRoom&edit=true&id=' . $ClassRoom_id ?>"
                    method="post">
                    <div class="input-group mb-3">
                        <span class="input-group-text" name="matheloai">Mã lớp</span>
                        <input type="text" class="form-control" id="matheloai" name="malop" disabled
                            placeholder="<?= $ClassRoom_id ?>">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" name="tenlop">Tên lớp</span>
