    ...
    <div class="container-fluid" style="padding:70px">
        <div class="row">
            <div class="col" id="admin_content">
                <a href="<?= DOMAIN . 'public/index.php?controller=home&action=add_Student' ?>"><button
                    ...
                    <tbody>
                        ...
                        foreach ($Students as $Student) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a
                                        href="<?= DOMAIN . 'public/index.php?controller=home&action=edit_Student&id=' . $Student->getId() ?>"><i
                                            class="bi bi-pencil-square">
                                        </i></a>
                                </td>
                                <td>
                                    <a href="<?= DOMAIN . 'public/index.php?controller=home&action=delete_Student&id=' . $Student->getId() ?>"
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <li class="page-item"><a class="page-link"
                                    href="<?= DOMAIN . 'public/index.php?controller=home&action=Student&key=' . $previous ?>">Previous</a>
                            </li>
                            <?php
                            for ($i = 1; $i <= $pages; $i++) {
                                if ($i == 1) {
                                    ...
                                    <li class="page-item"><a class="page-link active" id="<?= $i ?>"
                                            href="<?= DOMAIN . 'public/index.php?controller=home&action=Student&key=' . $i ?>">
                                            <?= $i ?>
                                        </a></li>
                                    <?php
                                    continue;
                            ...
                            ?>
                            <li class="page-item"><a class="page-link"
                                    href="<?= DOMAIN . 'public/index.php?controller=home&action=Student&key=' . $next ?>">Next</a>
                            </li>
                        </ul>
                    </nav>
                </div>
