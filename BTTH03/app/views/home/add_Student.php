        ...
        <div class="row">
            <div class="col text-center" id="admin_content">
                ...
                <form action="<?= DOMAIN . 'public/index.php?controller=home&action=add_Student&add=true' ?>"
                    method="post" id="form_add_student">
                    <div id="liveAlertPlaceholder"></div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1" style="width:100px">Họ và
                            tên</span>
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1" style="width:100px">Ngày
                            sinh</span>
                        <input type="text" class="form-control" name="ngaySinh" id="ngaySinh">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1" style="width:100px">Lớp</span>
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                foreach ($ClassRooms as $ClassRoom) {
                                    ?>
                                    <li class="dropdown-item" value="<?= $ClassRoom->getId() ?>" onclick="selectValue(this)"
                                        id="<?= $ClassRoom->getTenLop() ?>">
                                        <?= $ClassRoom->getTenLop() ?>
                                    </li>
                                    <li>
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn btn-success mx-2" onclick="validateForm(event)">Thêm</button>
