    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col text-center" id="admin_content">
                ...
                <form
                    action="<?= DOMAIN . 'public/index.php?controller=admin&action=edit_category&edit=true&id=' . $category_id ?>"
                    method="post">
                    <div class="input-group mb-3">
                        <span class="input-group-text" name="matheloai">Mã tác giả</span>
                        <input type="text" class="form-control" id="matheloai" name="matacgia" disabled
