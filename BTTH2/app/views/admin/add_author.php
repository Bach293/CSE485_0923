    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col text-center" id="admin_content">
                ...
                <form action="<?= DOMAIN . 'public/index.php?controller=admin&action=add_author&add=true' ?>"
                    method="post">
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1" name="tentheloai">Tên tác giả</span>
                        <input type="text" class="form-control" name="tentacgia">
                    </div>
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn btn-success mx-2">Thêm</button>
                        <a href="<?= DOMAIN . 'public/index.php?controller=admin&action=author' ?>"
