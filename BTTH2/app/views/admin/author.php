    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col" id="admin_content">
                <a href="<?= DOMAIN . 'public/index.php?controller=admin&action=add_author' ?>"><button
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        foreach ($authors as $author) {
                            $img = "../public/storage/images/" . $author->getHinh_tgia();
                            ?>
                            <tr>
                                <th scope="row" id="<?= $author->getMa_tgia() ?>">
                                    <?= $author->getMa_tgia() ?>
                                </th>
                                <th scope="row">
                                ...
                                <td>
                                    <a
                                        href="<?= DOMAIN . 'public/index.php?controller=admin&action=edit_author&id=' . $author->getMa_tgia() ?>"><i
                                            class="bi bi-pencil-square">
                                        </i></a>
                                </td>
                                <td>
                                    <a href="<?= DOMAIN . 'public/index.php?controller=admin&action=delete_author&id=' . $author->getMa_tgia() ?>"
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <li class="page-item"><a class="page-link"
                                    href="<?= DOMAIN . 'public/index.php?controller=admin&action=author&key=' . $previous ?>">Previous</a>
                            </li>
                            <?php
                            for ($i = 1; $i <= $pages; $i++) {
                                if ($i == 1) {
                                    ...
                                    <li class="page-item"><a class="page-link active" id="<?= $i ?>"
                                            href="<?= DOMAIN . 'public/index.php?controller=admin&action=author&key=' . $i ?>">
                                            <?= $i ?>
                                        </a></li>
                                    <?php
                                    continue;
                            ...
                            ?>
                            <li class="page-item"><a class="page-link"
                                    href="<?= DOMAIN . 'public/index.php?controller=admin&action=author&key=' . $next ?>">Next</a>
                            </li>
                        </ul>
                    </nav>
                </div>
