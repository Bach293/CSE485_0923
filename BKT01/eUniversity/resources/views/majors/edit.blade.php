                ...
                <form action="{{ route('majors.update', ['major' => $major->id]) }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name="artist_name" id="artist_name"
                            placeholder="Enter a name" value="{{ $major->name }}">
                    </div>
                    <div class="form-floating mb-3">
                        <textarea class="form-control" id="description" name="description" style="height: 150px">{{ $major->description }}</textarea>
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn btn-success mx-2" onclick="validateForm(event)">Edit</button>
